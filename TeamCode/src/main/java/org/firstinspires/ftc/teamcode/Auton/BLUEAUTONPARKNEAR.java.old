...
@Autonomous
public class BLUEAUTONPARKNEAR extends LinearOpMode {
    @Override
    public void runOpMode() {
        ...
        actor.add(new ClawAction(ClawAction.ClawStates.bottomClosed, ClawAction.ClawStates.topClosed), 2000.0)
                ...
                .add(new MvntAction(new Pose2d(-48, 0, new Rotation2d(0))))
                .add(new ClawAction(ClawAction.ClawStates.bottomOpen, ClawAction.ClawStates.topOpen), 2000.0);
