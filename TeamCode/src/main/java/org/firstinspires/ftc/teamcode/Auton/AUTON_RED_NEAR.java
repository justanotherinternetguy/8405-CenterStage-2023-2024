...
//                };
                ...
                direction = 2;
                path.add(new ClawAction(ClawAction.ClawStates.bottomClosed, ClawAction.ClawStates.topClosed))           // close claw
                        .add(new MvntAction(new Pose2d(0, 28, new Rotation2d(0))))                        // move to tape
                        ...
                        .add(new MvntAction(new Pose2d(24, 27.5, new Rotation2d(Math.toRadians(90)))))           // move to the board while moving the lift up
                        .add(new LiftAction(Config.LIFT_BACK, Config.liftMotorPowerAuton * 1.1), true)
                        .add(new MvntAction(new Pose2d(Config.BACKSPOT, 27.5, new Rotation2d(Math.toRadians(90))))) // move to the backboard
