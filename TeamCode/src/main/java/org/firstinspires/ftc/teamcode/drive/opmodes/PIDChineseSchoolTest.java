...
public class PIDChineseSchoolTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Movement movement = new Movement(robot.drive, new PID.Config(Config.translationPOther, Config.translationIOther, Config.translationDOther + 0.3), new PID.Config(Config.rotationPOther, Config.rotationIOther, Config.rotationDOther));
        Pose2d[] path = null;
